...
public class ClientUploader
{
    ...
    public String uploadFile(String filePath) {
        ...
        try {
            ...
            ossClient = new OSSClient(getOssEndpoint(uploadCredentials), uploadCredentials.getAccessKeyId(), uploadCredentials.getAccessKeySecret(),
    ...
    public String uploadBytes(byte[] bytes) {
        ...
        try {
            ...
            String object = uploadCredentials.getUploadFolder() + '/' + this.prefix + '/' + UUID
                    .randomUUID()
                    .toString();
    ...
    private UploadCredentials getCredentialsFromServer() throws Exception {
        ...
        uploadCredentialsRequest.setHttpContent(new JSONObject()
                .toJSONString()
                .getBytes("UTF-8"), "UTF-8", FormatType.JSON);
        ...
        try {
            ...
            if (httpResponse.isSuccess()) {
                ...
                if (200 == scrResponse.getInteger("code")) {
                    ...
                    return new UploadCredentials(data.getString("accessKeyId"), data.getString("accessKeySecret"), data.getString("securityToken"),
                            data.getLongValue("expiredTime"), data.getString("ossEndpoint"), data.getString("ossInternalEndpoint"), data.getString("uploadBucket"),
                            data.getString("uploadFolder"));
                }
