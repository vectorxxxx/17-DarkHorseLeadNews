...
public class UploadCredentials implements Serializable
{
    ...
    public UploadCredentials(String accessKeyId, String accessKeySecret, String securityToken, Long expiredTime, String ossEndpoint, String ossInternalEndpoint,
                             String uploadBucket, String uploadFolder) {
