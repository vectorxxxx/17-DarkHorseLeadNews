...
public class WmSensitiveServiceImpl extends ServiceImpl<WmSensitiveMapper, WmSensitive> implements WmSensitiveService
{
    ...
    public ResponseResult list(SensitiveDto dto) {
        ...
        LambdaQueryWrapper<WmSensitive> lambdaQueryWrapper = new LambdaQueryWrapper<WmSensitive>().like(StringUtils.isNotBlank(dto.getName()), WmSensitive::getSensitives,
                dto.getName());
