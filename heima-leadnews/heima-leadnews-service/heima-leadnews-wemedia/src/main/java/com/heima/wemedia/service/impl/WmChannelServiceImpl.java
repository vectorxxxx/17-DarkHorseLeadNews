...
public class WmChannelServiceImpl extends ServiceImpl<WmChannelMapper, WmChannel> implements WmChannelService
{
    ...
    public ResponseResult insert(WmChannel wmChannel) {
        ...
        WmChannel channel = getOne(Wrappers
                .<WmChannel>lambdaQuery()
    ...
    public ResponseResult findByNameAndPage(ChannelDto dto) {
        ...
        // 频道名称模糊查询
        LambdaQueryWrapper<WmChannel> lambdaQueryWrapper = new LambdaQueryWrapper<WmChannel>().like(StringUtils.isNotBlank(dto.getName()), WmChannel::getName, dto.getName());
